---
title: Obsidian Plugin Updates 2025-10-05 to 2025-10-11
description: 'From 2025-10-05 to 2025-10-11 there are 3 newly released plugins and 41 plugin updates'
excerpt: 'There are 3 new plugins and 41 plugin updates during the week 2025-10-04 to 2025-10-11.'
...
### 1. [Google Calendar Importer](/plugins/google-calendar-importer)

Released on 2025-10-11 by [Fan Li](https://github.com/lexafaxine)
...
[View Details](/plugins/google-calendar-importer), [Github](https://github.com/lexafaxine/GoogleCalendarImporter)

---

### 2. [Tasks Map](/plugins/tasks-map)

Released on 2025-10-11 by [NicoKNL](https://github.com/NicoKNL)
...
[View Details](/plugins/tasks-map), [Github](https://github.com/NicoKNL/tasks-map)

```plugin-image
description:
url: https://raw.githubusercontent.com/NicoKNL/tasks-map/main/.github/images/example-tasks.png
source:github
```

---

### 3. [Radial timeline](/plugins/radial-timeline)

Released on 2025-10-10 by [Eric Rhys Taylor](https://github.com/EricRhysTaylor)
...
[View Details](/plugins/radial-timeline), [Github](https://github.com/EricRhysTaylor/Radial-Timeline)

```plugin-image
description:
url: https://raw.githubusercontent.com/EricRhysTaylor/radial-timeline/master/RadialTimeline_Screenshot1.jpeg
source:github
```
...
We got 41 plugin updates in the last one week's time. You can see all the plugin updates on [Obsidian Plugin Stats webapp](/updates).

### Notable Updates

- **Task Notes** - v3.25.0 - [Changelog](https://github.com/callumalpass/tasknotes/releases/tag/3.25.0)
- \*\*Notebook Navigator88 - v1.5.2 - [Changelog](https://github.com/johansan/notebook-navigator/releases/tag/1.5.2)
- **Map View** - v6.0.0 - [Changelog](https://github.com/esm7/obsidian-map-view?tab=readme-ov-file#600)
