      ...
      {updatesForFavPlugins && updatesForFavPlugins.length > 0 && (
        <div className="bg-transparent mt-16">
          <div className="max-w-6xl mx-auto px-2">
            ...
            <div>
              There are {updatesForFavPlugins?.length || 0} new updates from the
              last 10 days
            </div>
      ...
      {(!updatesForFavPlugins || updatesForFavPlugins.length === 0) &&
        ...
        favorites.length > 0 && (
          <div className="bg-transparent mt-16">
            <div className="max-w-6xl mx-auto px-2">
              <InfoBar title="New Versions of your favorite plugins" />
              There are no new updates from your favorite plugins in the recent
              days. Developers must be busy coding up some nice feature for you!
              <div className="w-full flex justify-center my-2">
                <Image
                  src="/images/empty.svg"
                  alt={'No new updates for your favorite plugins'}
                  width={256}
                  height={128}
                />
              </div>
