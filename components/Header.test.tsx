...
describe('Header', () => {
  ...
  it('renders the title, meta tags, and JSON-LD schema correctly', () => {
    ...
    expect(document.querySelector('meta[property="og:url"]')).toHaveAttribute('content', 'https://example.com');
    ...
    expect(document.querySelector('meta[name="twitter:image"]')).toHaveAttribute('content', 'https://example.com/image.png');
    expect(document.querySelector('meta[name="twitter:site"]')).toHaveAttribute('content', '@ganesshkumar');
