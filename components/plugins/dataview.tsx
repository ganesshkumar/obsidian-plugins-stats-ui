...
export const DataviewSection = () => {
  ...
  const handleCTAButtonClick = () => {
    ...
    window.open(
      'https://chatgpt.com/g/g-67f63dc319588191a4bb13d0def278b0-obsidian-dataview-query-wizard',
      '_blank'
    );
  };
    ...
    <Card theme={customCardTheme} className="relative mt-4">
      <div className="flex flex-col justify-center text-center">
        ...
        <p className="text-sm text-gray-600">
          {' '}
          A custom GPT that helps Obsidian users write, understand, and debug
          Dataview queries.{' '}
        </p>
        <p className="text-sm text-gray-600">
          {' '}
        ...
        <Button
          color="purple"
          className="mx-auto mt-4 max-w-96 flex items-center"
