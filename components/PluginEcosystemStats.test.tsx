...
describe('PluginEcosystemStats', () => {
  ...
  test('renders new plugins stat', () => {
    ...
    expect(newPluginsStat).toHaveClass('text-7xl font-bold tracking-tight text-violet-900 dark:text-white text-center');
  ...
  test('renders recently updated plugins stat', () => {
    ...
    expect(newReleasesStat).toHaveClass('text-7xl font-bold tracking-tight text-violet-900 dark:text-white text-center');
  ...
  test('renders total plugins stat', () => {
    render(<PluginEcosystemStats {...props} />);
    const totalPluginsStat = screen.getByText(props.totalPluginsCount.toString());
    expect(totalPluginsStat).toBeInTheDocument();
    expect(totalPluginsStat).toHaveClass('text-7xl font-bold tracking-tight text-violet-900 dark:text-white text-center');
  ...
  test('renders correct links for stats', () => {
    ...
    const newReleasesLink = screen.getByRole('link', { name: /Recently Updated Plugins/i });
    expect(newReleasesLink).toHaveAttribute('href', '/updates');
    const totalPluginsLink = screen.getByRole('link', { name: /Total Plugins/i });
