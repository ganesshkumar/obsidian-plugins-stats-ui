      ...
      case 1:
        percentage =
          ratingInfo.ratingCount === 0
            ? 0
            : (ratingInfo.star1Count / ratingInfo.ratingCount) * 100;
        break;
      case 2:
        percentage =
          ratingInfo.ratingCount === 0
            ? 0
            : (ratingInfo.star2Count / ratingInfo.ratingCount) * 100;
        break;
      case 3:
        percentage =
          ratingInfo.ratingCount === 0
            ? 0
            : (ratingInfo.star3Count / ratingInfo.ratingCount) * 100;
        break;
      case 4:
        percentage =
          ratingInfo.ratingCount === 0
            ? 0
            : (ratingInfo.star4Count / ratingInfo.ratingCount) * 100;
        break;
      case 5:
        percentage =
          ratingInfo.ratingCount === 0
            ? 0
            : (ratingInfo.star5Count / ratingInfo.ratingCount) * 100;
        break;
    }
    ...
    <div className="flex gap-x-8">
      <div>
        <div className="text-6xl tracking-tighter font-bold">
          {(ratingInfo.avgRating ?? 0).toFixed(1)}
        </div>
        <div>{stars}</div>
