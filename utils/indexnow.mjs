...
function submitToIndexNow(filteredUrls) {
    ...
    const submissionData = {
        ...
        keyLocation: 'https://obsidian-plugin-stats.ganesshkumar.com/a944fdca7e16402a80e17aead9645552.txt',
...
async function main() {
    try {
        ...
        const sitemapData = await fetchSitemap('https://obsidian-plugin-stats.ganesshkumar.com/sitemap-0.xml');
