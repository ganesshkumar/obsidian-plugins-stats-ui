...
const Demo = (props: IWrapped2025PageProps) => {
  return (
    <>
      <Header {...props} />
      <Intro />
...
const Intro = () => {
  ...
  return (
    <div
      className="h-[180vh] flex flex-col items-center justify-center bg-violet-800"
      id="start"
    >
      ...
      <div className="h-[80vh] w-full flex flex-col justify-center items-center fixed top-0">
        ...
        ></motion.div>
        <motion.div
          className="absolute top-0 w-full flex justify-center items-center h-full"
        ...
        >
          <Image
            ...
            width={128}
            height={128}
            alt="Obsidian Plugins Stats Logo"
  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row grow justify-center">
        <div className="w-full md:w-1/2 lg:ml-8 grid content-center">
          <div className="text-4xl py-4 font-bold text-slate-100">
            Milestones achived in 2025
          </div>
          <ul className="list-disc flex flex-col gap-y-4">
            <li className="ml-5 text-2xl text-slate-300">
              Crossed{' '}
              <span className="font-bold text-3xl text-slate-100">
                {props.milestone.totalPlugins.toLocaleString()}
              </span>{' '}
              published plugins.
            </li>
            <li className="ml-5 text-2xl text-slate-300">
              Crossed{' '}
              <span className="font-bold text-3xl text-slate-100">
                {props.milestone.totalThemes.toLocaleString()}
              </span>{' '}
              published themes.
            </li>
            <li className="ml-5 text-2xl text-slate-300">
              Surpassed{' '}
              <span className="font-bold text-3xl text-slate-100">
                {props.milestone.totalPluginDownloads.toLocaleString()}
              </span>{' '}
              plugin downloads.
            </li>
          </ul>
        ...
        <div className="w-1/2 ml-20 overflow-visible grid content-center">
          <img
            src="/images/undraw/undraw_celebration_re_kc9k.svg"
            className=""
          />
        </div>
      </div>
...
const StatsSection = (props) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row grow justify-center">
        <div className="wfull md:w-1/2 lg:ml-8 grid content-center">
          <div className="text-4xl py-4 font-bold text-amber-400">In 2025</div>
          <ul className="flex flex-col gap-y-4">
            <li className="text-2xl">
              <motion.div
                className="bg-amber-400 rounded-md text-left p-4 shadow-amber-400 cursor-context-menu"
                ref={ref1}
            ...
            <li className="text-2xl">
              ...
              >
                ...
                <div className="text-2xl flex gap-x-1 text-gray-800">
                  <PlusCircle size={28} /> New Plugins
                </div>
              </motion.div>
            </li>
            <li className="text-2xl">
              ...
              >
                <div className="font-bold text-5xl mb-2 text-gray-800">
                  {props.stats.newThemesCount.toLocaleString()}
                </div>
                <div className="text-2xl flex gap-x-1 text-gray-800">
                  <PlusCircle size={28} /> New Themes
                </div>
              </motion.div>
            </li>
            <li className="text-2xl">
              ...
              >
                ...
                <div className="text-2xl flex gap-x-1 text-gray-800">
                  <RefreshCw size={28} /> Plugin Updates
                </div>
              </motion.div>
            </li>
            <li className="text-2xl">
              ...
              >
                <div className="font-bold text-5xl mb-2 text-gray-800">
                  {props.stats.pluginDownloadCount.toLocaleString()}
                </div>
                <div className="text-2xl flex gap-x-1 text-gray-800">
                  <Download size={28} /> Plugin Downloads
                </div>
              </motion.div>
            </li>
          </ul>
    ...
    >
      <div className="flex flex-col lg:flex-row grow justify-center h-full">
        <ul className="flex flex-col justify-center gap-y-2">
          <li>
            <div className="text-4xl py-4 font-bold text-amber-400">
              Top New Plugins Released in 2025
            </div>
          </li>
          {Object.keys(props.mostDownloadedFromNewPlugins).map(
            (pludingId, idx) => {
              return (
                <li key={pludingId} className="text-2xl">
                  <div className="flex items-center gap-x-4">
                    ...
                    <span>
                      <a
                        href={`/plugins/${pludingId}`}
                        className="cursor-pointer underline grow mr-8"
                      >
                        {props.mostDownloadedFromNewPlugins[pludingId].name}
                      </a>
                    </span>
                    <span className="w-32 flex flex-col ml-auto items-center">
                      <span className="text-amber-400">
                        {props.mostDownloadedFromNewPlugins[
                          pludingId
    ...
    >
      <div className="flex flex-col lg:flex-row grow justify-center h-full">
        <ul className="flex flex-col justify-center gap-y-2">
          <li>
            <div className="text-4xl py-4 font-bold text-amber-400">
              Most downloaded plugins in 2025
            </div>
          </li>
          {Object.keys(props.mostDownloadedPlugins).map((pludingId, idx) => {
            return (
              <li key={pludingId} className="text-2xl">
                <div className="flex items-center gap-x-4">
                  <span className="w-8 pr-2">{idx + 1}.</span>
                  <span>
                    <a
                      ...
                      className="cursor-pointer underline grow mr-8"
                    >
                      {props.mostDownloadedPlugins[pludingId].name}
                    </a>
                  </span>
                  <span className="w-32 flex flex-col ml-auto items-center">
                    <span className="text-amber-400">
  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row grow justify-center h-full">
        <ul className="flex flex-col justify-center gap-y-2">
          <li>
            <div className="text-4xl py-4 font-bold text-gray-700">
              Plugins received most updates in 2025
            </div>
          </li>
          {Object.keys(props.mostUpdatedPlugins).map((pludingId, idx) => {
            return (
                ...
                <div className="flex items-center gap-x-4">
                  ...
                  <span>
                    <a
                      ...
                      className="cursor-pointer underline grow mr-8"
                    >
                      {props.mostUpdatedPlugins[pludingId].name}
                    </a>
                  </span>
                  <span className="w-32 flex flex-col ml-auto items-center">
                    <span className="text-cyan-600">
                      {props.mostUpdatedPlugins[
                        pludingId
  ...
  return (
    ...
    >
      <div className="h-full flex flex-col justify-center items-center">
        <div className="text-center text-4xl my-4 font-bold text-amber-400 mb-12">
          Developers who created most plugins
        </div>
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="hidden md:flex justify-center items-center lg:w-1/2">
            <img
              src="/images/undraw/undraw_programmer_re_owql.svg"
              width={384}
              height={384}
              alt="Obsidian Plugins Stats Logo"
              className="rounded-2xl"
          ...
          <div className="flex md:hidden justify-center items-center lg:w-1/2">
            <img
              src="/images/undraw/undraw_programmer_re_owql.svg"
              width={192}
              height={192}
          ...
          <div className="lg:w-1/2 flex flex-col justify-center">
            {Object.entries(props.mostPluginsByAuthor).map(
                ...
                return (
                  <div key={index} className="flex py-2 mt-2">
                    <div className="text-xl flex gap-x-2 items-baseline text-left">
                      <motion.a
                        href={`https://github.com/${data[1][0].repo.split('/')[0]}`}
                        className="text-2xl text-amber-400 font-bold underline"
                        whileHover={{ scale: 1.1 }}
                      >
                        {data[0]}
                      </motion.a>
                      ...
                      >
                        <div className="bg-transparent px-0 mx-0 underline decoration-dotted cursor-pointer">
  ...
  const handleNextSectionClick = () => {
    if (document) {
      if (props.nextSectionId) {
        document
          .getElementById(props.nextSectionId)
          ?.scrollIntoView({ behavior: 'smooth' });
      } else {
        document
          .getElementById('milestone')
    ...
    >
      <div className="max-w-6xl mx-auto px-4 flex flex-col h-screen">
        <div>
          <div
            id={props.sectionId}
            className={`text-center text-2xl lg:text-5xl font-bold pt-4 ${props.titleClasses ?? ''}`}
          >
        ...
        {props.nextSectionId ? (
          <motion.div
            ...
            whileTap={{ scale: 0.8 }}
          >
            <Button color="dark" onClick={handleNextSectionClick}>
              <ArrowDownCircle
                className={`mr-2 h-5 w-5 ${!props.nextSectionId ? 'collapsed' : ''}`}
              />{' '}
              Next
            </Button>
          </motion.div>
...
export const getStaticProps = async () => {
  const data = require('../../data/wrapped-2025.json');
  const title = 'Obsidian Plugins Wrapped 2025';
  const description =
    'Discover Obsidian Plugins journey in 2025! From new plugin releases and updates to standout developers and the most downloaded plugins, explore the milestones and community contributions that shaped the Obsidian ecosystem this year.';
  const canonical =
  ...
  const post: Post = {
    ...
    title:
      'Obsidian Plugins Wrapped 2025 - Key Milestones, Top Plugins, and Developer Highlights',
    description:
      'Discover Obsidian Plugins journey in 2025! From new plugin releases and updates to standout developers and the most downloaded plugins, explore the milestones and community contributions that shaped the Obsidian ecosystem this year.',
    excerpt:
      'Obsidian Plugins Wrapped 2025 - Key Milestones, Top Plugins, and Developer Highlights',
