        ...
        <div className="w-1/2 lg:ml-8 grid content-center">
          ...
          <ul className="list-disc flex flex-col gap-y-4">
            ...
            <li className="ml-5 text-2xl text-slate-300">
              Surpassed{' '}
              <span className="font-bold text-3xl text-slate-100">
                {props.milestone.totalDownloads.toLocaleString()}
              </span>{' '}
              plugin downloads.
            </li>
          </ul>
    ...
    >
      <div className="flex flex-col lg:flex-row grow justify-center h-full">
        <ul className="flex flex-col justify-center gap-y-2">
          <li>
            <div className="text-4xl py-4 font-bold text-amber-400">
              Most downloaded plugins in 2024
            </div>
          </li>
                ...
                <div className="flex items-center gap-x-4">
                  ...
                  <span>
                    <a
                      ...
                      className="cursor-pointer underline grow mr-8"
                    >
                      {props.mostDownloaded[pludingId].name}
                    </a>
                  </span>
                  <span className="w-32 flex flex-col ml-auto items-center">
                    <span className="text-amber-400">
                      {props.mostDownloaded[pludingId].delta.toLocaleString()}
                    </span>
                    <span className="text-sm">Downloads</span>
                  </span>
                </div>
                ...
                <div className="flex items-center gap-x-4">
                  ...
                  <span>
                    <a
                      ...
                      className="cursor-pointer underline grow mr-8"
                    >
                      {props.mostUpdated[pludingId].name}
                    </a>
                  </span>
                  <span className="w-32 flex flex-col ml-auto items-center">
...
export const getStaticProps = async () => {
  ...
  const canonical="https://obsidian-plugin-stats.ganesshkumar.com/posts/2024-12-07-wrapped-2024"
