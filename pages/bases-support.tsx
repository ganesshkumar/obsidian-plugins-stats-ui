...
const BASES_SUPPORT_DATA: IBaseSupportEntry[] = [
  {
    ...
    releaseUrl:
      'https://github.com/zsviczian/obsidian-excalidraw-plugin/releases/tag/2.13.1',
    confidence: 95,
    explanation:
      "The release notes explicitly state 'Support for Obsidian bases as embeddables in Excalidraw.' This clearly adds support for Obsidian bases functionality.",
  ...
  },
  {
    ...
    releaseUrl:
      'https://github.com/mdelobelle/obsidian_supercharged_links/releases/tag/0.13.0',
    confidence: 95,
    explanation:
      'The release notes explicitly mention adding support for the new bases core plugin, indicating integration with Obsidian bases functionality.',
  ...
  },
  {
    ...
    releaseUrl:
      'https://github.com/mirnovov/obsidian-homepage/releases/tag/4.2.1',
    confidence: 98,
    explanation:
      "The release notes explicitly state ‘Add support for Obsidian's new Bases feature,’ confirming support for Obsidian bases.",
  ...
  },
  {
    ...
    releaseUrl:
      'https://github.com/vrtmrz/obsidian-livesync/releases/tag/0.25.9',
    confidence: 85,
    explanation:
      'The notes explicitly state that the editor statusline now supports ‘Bases’, indicating added support for bases functionality.',
  ...
  },
  {
    ...
    releaseUrl:
      'https://github.com/Quorafind/Obsidian-Task-Genius/releases/tag/9.8.0-beta.0',
    confidence: 85,
    explanation:
      'The notes include a ‘refactor(bases): enhance Bases API compatibility and content handling’ entry, indicating work on bases support.',
  ...
  },
  {
    ...
    releaseUrl:
      'https://github.com/brianpetro/obsidian-smart-connections/releases/tag/3.0.45',
    confidence: 90,
    explanation:
      'Multiple patch notes refer to “bases integration,” including improvements, new options in “bases connection score modal,” and temporary disabling of bases integration, indicating support for bases functionality.',
  ...
  },
  {
    ...
    releaseUrl:
      'https://github.com/gasparschott/obsidian-continuous-mode/releases/tag/3.4.0',
    confidence: 90,
    explanation:
      'The notes explicitly state “Added compatibility with base files,” indicating support for Obsidian bases functionality.',
  ...
  },
  {
    ...
    releaseUrl:
      'https://github.com/chrisgurney/obsidian-note-toolbar/releases/tag/1.24-beta-02',
    confidence: 95,
    explanation:
      'The release notes include a “Toolbars in Bases” feature that explicitly enables toolbars in Obsidian’s new Bases core plugin, indicating added support for Bases functionality.',
  ...
  },
  {
    ...
    confidence: 85,
    explanation:
      'Release notes include a bugfix for Obsidian bases (‘Bases can now be customized correctly from their tab’), indicating support for bases functionality.',
  ...
  },
  {
    ...
    releaseUrl:
      'https://github.com/likemuuxi/obsidian-modal-opener/releases/tag/1.1.12',
    confidence: 95,
    explanation:
      'The release notes explicitly mention “Support Base card view,” indicating added support for base (database-like) functionality.',
  ...
  },
  {
    ...
    releaseUrl:
      'https://github.com/Devon22/obsidian-gridexplorer/releases/tag/2.9.8',
    confidence: 85,
    explanation:
      'The notes explicitly mention “Support base … in shortcut files,” indicating addition of base (i.e. Obsidian bases) support alongside canvas.',
  ...
  },
  {
    ...
    confidence: 95,
    explanation:
      'The release includes a new “Bases Plugin Integration” feature with experimental integration, formula computation, custom property support, and kanban view for the Bases plugin, indicating added support for Obsidian bases.',
  ...
  },
  {
    ...
    confidence: 95,
    explanation:
      'The release notes explicitly mention initial styles and settings for Obsidian Bases.',
  ...
  },
  {
    ...
    releaseUrl:
      'https://github.com/tingmelvin/willemstad-x/releases/tag/v1.9.0',
    confidence: 95,
    explanation:
      'The notes explicitly state expanded support for the Bases core plugin (‘new look for Bases and Canvas’) under Plugin Integration.',
  ...
  },
  {
    ...
    confidence: 95,
    explanation:
      "The release notes include a feature commit (e02986a) explicitly stating 'add plugin core bases support,' indicating added support for Obsidian bases.",
  ...
  },
  {
    ...
    confidence: 90,
    explanation:
      'The release notes include “Added experimental Bases style settings,” indicating support for Obsidian bases functionality (styling for bases).',
  ...
  },
  {
    ...
    releaseUrl:
      'https://github.com/Gonzalo-D-Sales/obsidian-velocity/releases/tag/v1.0.4-alpha',
    confidence: 90,
    explanation:
      'The release notes explicitly mention custom styling for the Bases core plugin, indicating added support for Obsidian bases functionality.',
    addedAt: '2025-09-13T09:16:28.269Z',
  },
];

const BasesSupportPage = (
  props: IHeaderProps & { suggestions: Suggestions }
) => {
  ...
  const filtered = useMemo(() => {
    ...
    const filteredByType =
      filter === 'all' ? list : list.filter((l) => l.type === filter);
    ...
    <div>
      ...
      <div className="bg-white pt-5">
        <ResponsiveLayout sidebar={sidebar}>
          <InfoBar
            title={`Plugins & Themes with Bases Support (${BASES_SUPPORT_DATA.length})`}
          />
          ...
          {isLessThanLarge && (
            <EthicalAd
              type="text"
              style="fixed-footer"
              placementId="bases-support-fixed-footer"
            />
          )}

          <div className="mt-4 text-sm text-gray-700 prose prose-sm max-w-none">
            <p>
              Obsidian's new <strong>Bases</strong> feature lets you treat your
              notes like a structured database - filter, sort and organize
              properties with ease. To kick things off, I've put together an{' '}
              <em>
                <strong>
                  experimental list of plugins and themes that already support
                  Bases
                </strong>
              </em>
              , along with the versions where support was added. This is just a
              starting point and I'd love your help in making it more complete.
              If you know of any plugins or themes with Bases support that
              aren't listed yet, please let me know so I can add them.
            </p>
          </div>
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="text-right">
                        <div
                          className={`inline-block text-sm font-semibold px-2 py-1 rounded-md shadow-sm ${e.type === 'plugin' ? 'bg-violet-700 text-white' : 'bg-green-700 text-white'}`}
                        >
                    ...
                    <div className="mt-4">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-block bg-gray-700 text-white px-3 py-1 rounded-md text-sm hover:bg-gray-600"
                      >
                        View Release
                      </a>
                    </div>
          ...
          <div className="mt-16">
            <div className="max-w-2xl mx-auto text-center mb-8">
              ...
              <p className="text-center text-sm text-gray-600 mt-2">
                Know a plugin or theme that supports Bases but is not listed
                here? Please leave a comment with the name and a link to the
                release notes or repository - we will review it and add it to
                the list.
              </p>
            </div>
            <Comments />
...
export const getStaticProps: GetStaticProps = async () => {
  ...
  const description =
    'A curated list of Obsidian plugins and themes that added support for the new Bases core plugin.';
