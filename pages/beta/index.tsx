    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="bg-white pt-5 grow">
        <div className="max-w-6xl mx-auto px-2">
          <InfoBar
            title={`Beta Plugins and Themes ${entries.length ? `(${entries.length})` : ''}`}
          />
          <div className="my-4">
            <div className="border-l-4 border-yellow-400 bg-yellow-50 p-4 rounded">
              <div className="font-semibold text-yellow-800 mb-2">
                Note: Beta plugins & themes are used at your own risk
              </div>
              <ul className="list-disc pl-5 text-yellow-700 text-sm">
                <li>
                  These are plugins & themes with open PRs waiting to be merged
                  into the community plugin/theme lists.
                </li>
                <li>
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4 mb-2">
            <div className="relative md:w-1/2">
              ...
              <input
                ...
                placeholder="Search beta entries"
          ...
          <div className="mb-4 flex items-center gap-x-4 text-sm font-medium">
            ...
            <Link
              href="/beta"
              className={`underline-offset-4 underline ${typeof window !== 'undefined' && window.location.pathname === '/beta' ? 'underline font-semibold' : ''}`}
            >
              All
            </Link>
            <Link
          ...
          {!!entries.length && (
            <div className="mt-6 text-xs text-gray-500">
              * These entries are derived from open GitHub PRs proposing new
              plugins or themes and may change.
            </div>
          )}
        </div>
      </main>
